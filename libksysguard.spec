...
Version  : 5.18.3
Release  : 34
URL      : https://github.com/KDE/libksysguard/archive/v5.18.3/libksysguard-5.18.3.tar.gz
Source0  : https://github.com/KDE/libksysguard/archive/v5.18.3/libksysguard-5.18.3.tar.gz
...
%prep
%setup -q -n libksysguard-5.18.3
cd %{_builddir}/libksysguard-5.18.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583864094
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libksysguard-5.18.3/COPYING %{buildroot}/usr/share/package-licenses/libksysguard/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libksysguard-5.18.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/libksysguard/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.18.3
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.18.3
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.18.3
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.18.3
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.18.3
