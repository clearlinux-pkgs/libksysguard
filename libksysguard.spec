...
Source0  : https://github.com/KDE/libksysguard/archive/v5.16.3/libksysguard-5.16.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562730826
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.16.3
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.16.3
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.16.3
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.16.3
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.16.3
