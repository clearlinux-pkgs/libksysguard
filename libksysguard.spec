...
%prep
%setup -q -n libksysguard-5.19.0
cd %{_builddir}/libksysguard-5.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591735520
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libksysguard-5.19.0/COPYING %{buildroot}/usr/share/package-licenses/libksysguard/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libksysguard-5.19.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/libksysguard/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
