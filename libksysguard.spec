...
Version  : 6.1.2
Release  : 105
URL      : https://download.kde.org/stable/plasma/6.1.2/libksysguard-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/libksysguard-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/libksysguard-6.1.2.tar.xz.sig
...
%setup -q -n libksysguard-6.1.2
cd %{_builddir}/libksysguard-6.1.2
pushd ..
cp -a libksysguard-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720614250
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSysGuardFormatter.so.6.1.2
/V3/usr/lib64/libKSysGuardSensorFaces.so.6.1.2
/V3/usr/lib64/libKSysGuardSensors.so.6.1.2
/V3/usr/lib64/libKSysGuardSystemStats.so.6.1.2
/V3/usr/lib64/libprocesscore.so.6.1.2
...
/usr/lib64/libKSysGuardFormatter.so.6.1.2
/usr/lib64/libKSysGuardSensorFaces.so.2
/usr/lib64/libKSysGuardSensorFaces.so.6.1.2
/usr/lib64/libKSysGuardSensors.so.2
/usr/lib64/libKSysGuardSensors.so.6.1.2
/usr/lib64/libKSysGuardSystemStats.so.2
/usr/lib64/libKSysGuardSystemStats.so.6.1.2
/usr/lib64/libprocesscore.so.10
/usr/lib64/libprocesscore.so.6.1.2
...
%files locales -f KSysGuardSensorFaces.lang -f ksysguard_face_org.kde.ksysguard.barchart.lang -f ksysguard_face_org.kde.ksysguard.colorgrid.lang -f ksysguard_face_org.kde.ksysguard.facegrid.lang -f ksysguard_face_org.kde.ksysguard.linechart.lang -f ksysguard_face_org.kde.ksysguard.piechart.lang -f ksysguard_face_org.kde.ksysguard.textonly.lang -f ksysguard_sensors.lang -f processcore.lang -f KSysGuardFormatter.lang -f ksysguard_face_org.kde.ksysguard.horizontalbars.lang -f ksysguard_systemstats.lang
%defattr(-,root,root,-)
