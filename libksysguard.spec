...
Source0  : https://github.com/KDE/libksysguard/archive/v5.14.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539705285
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.14.1
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.14.1
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.14.1
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.14.1
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.14.1
