...
Version  : 5.15.3
Release  : 16
URL      : https://github.com/KDE/libksysguard/archive/v5.15.3.tar.gz
Source0  : https://github.com/KDE/libksysguard/archive/v5.15.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552410252
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.15.3
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.15.3
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.15.3
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.15.3
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.15.3
