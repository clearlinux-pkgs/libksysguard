...
Version  : 5.14.2
Release  : 7
URL      : https://github.com/KDE/libksysguard/archive/v5.14.2.tar.gz
Source0  : https://github.com/KDE/libksysguard/archive/v5.14.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540463061
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.14.2
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.14.2
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.14.2
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.14.2
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.14.2
