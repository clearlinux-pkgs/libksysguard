...
Source0  : https://download.kde.org/stable/plasma/5.27.7/libksysguard-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/libksysguard-5.27.7.tar.xz.sig
...
%prep
%setup -q -n libksysguard-5.27.7
cd %{_builddir}/libksysguard-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690903021
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSysGuardFormatter.so.5.27.7
/V3/usr/lib64/libKSysGuardSensorFaces.so.5.27.7
/V3/usr/lib64/libKSysGuardSensors.so.5.27.7
/V3/usr/lib64/libKSysGuardSystemStats.so.5.27.7
/V3/usr/lib64/libksgrd.so.5.27.7
/V3/usr/lib64/libksignalplotter.so.5.27.7
/V3/usr/lib64/liblsofui.so.5.27.7
/V3/usr/lib64/libprocesscore.so.5.27.7
/V3/usr/lib64/libprocessui.so.5.27.7
...
/usr/lib64/libKSysGuardSystemStats.so.5.27.7
