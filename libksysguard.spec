...
Version  : 6.2.0
Release  : 111
URL      : https://download.kde.org/stable/plasma/6.2.0/libksysguard-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/libksysguard-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/libksysguard-6.2.0.tar.xz.sig
...
%setup -q -n libksysguard-6.2.0
cd %{_builddir}/libksysguard-6.2.0
pushd ..
cp -a libksysguard-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728773880
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSysGuardFormatter.so.6.2.0
/V3/usr/lib64/libKSysGuardSensorFaces.so.6.2.0
/V3/usr/lib64/libKSysGuardSensors.so.6.2.0
/V3/usr/lib64/libKSysGuardSystemStats.so.6.2.0
/V3/usr/lib64/libprocesscore.so.6.2.0
...
/usr/lib64/libKSysGuardFormatter.so.6.2.0
/usr/lib64/libKSysGuardSensorFaces.so.2
/usr/lib64/libKSysGuardSensorFaces.so.6.2.0
/usr/lib64/libKSysGuardSensors.so.2
/usr/lib64/libKSysGuardSensors.so.6.2.0
/usr/lib64/libKSysGuardSystemStats.so.2
/usr/lib64/libKSysGuardSystemStats.so.6.2.0
/usr/lib64/libprocesscore.so.10
/usr/lib64/libprocesscore.so.6.2.0
