...
Source0  : https://github.com/KDE/libksysguard/archive/v5.13.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533055412
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.13.4
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.13.4
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.13.4
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.13.4
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.13.4
