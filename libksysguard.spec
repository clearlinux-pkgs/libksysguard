...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libksgrd.so.5.14.3
/usr/lib64/libksgrd.so.7
/usr/lib64/libksignalplotter.so.5.14.3
/usr/lib64/libksignalplotter.so.7
/usr/lib64/liblsofui.so.5.14.3
/usr/lib64/liblsofui.so.7
/usr/lib64/libprocesscore.so.5.14.3
/usr/lib64/libprocesscore.so.7
/usr/lib64/libprocessui.so.5.14.3
